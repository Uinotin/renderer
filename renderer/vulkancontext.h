...
FUNCDECL(GetImageMemoryRequirements);
FUNCDECL(GetPhysicalDeviceMemoryProperties);
...
FUNCDECL(DestroyImage);
FUNCDECL(DeviceWaitIdle);
FUNCDECL(AllocateMemory);
FUNCDECL(BindImageMemory);
